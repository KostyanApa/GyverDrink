...
//if pump =1
//TIME_50ML 5000;  // время заполнения 50 мл
//if pump >1
#define TIME_50MLall 5000, 5000, 5000
#define TIME_50ML 5000
#define TIME2_50ML 5000
#define TIME3_50ML 5000
...
//╞════════════════════════════════════════════════════════════════════════════════════╣ Соединения ╠════════════════════════════════════════════════════════════════════════════════════╡
//#define SHOT_Pump       30, 30, 40 //время для заливки 50мл
#define Num_PUMP   3
#define PUMP_POWER   2, 3, 4        // управляющий сигнал драйвера помпы (обычно обозначен как IN на драйверах моторов, либо GATE/BASE, если используется транзистор)
uint8_t PumpsPower[] = {PUMP_POWER};

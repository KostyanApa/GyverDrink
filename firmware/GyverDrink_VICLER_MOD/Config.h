...
#define TIME_50ML      7000  // время заполнения 50 мл
#define TIME_50ML2      4000  // время заполнения 50 мл
#define TIME_50ML3      4000  // время заполнения 50 мл
#define MAX_VOLUME     70    // ограничение максимального объёма. Максимальное значение 255
...
#define MOTOR_AUTO_POWER  0           // авто отключение двигателя во время простоя
#define SAVE_MODE         1           // 1 → сохранение последнего активного режима в памяти, 0 → не сохраняется
...
#define PUMP_POWER   2        // управляющий сигнал драйвера помпы (обычно обозначен как IN на драйверах моторов, либо GATE/BASE, если используется транзистор)
#define PUMP2_POWER  3
#define PUMP3_POWER  4
#define ShotON       13			//Кнопка налива шотов
